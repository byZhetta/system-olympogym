...
<body>
	...
	<section id="container">
        ...
        <a href="registro_instructor.php" class="btn_new"><i class="fas fa-plus"></i> Crear Proveedor</a>

        <form action="buscar_proveedor.php" mathod="get" class="form_search">
            <input type="text" name="busqueda" id="busqueda" placeholder="Nombre / CP / Email" value="<?php echo $busqueda; ?>">
            ...
            <?php
                ...
                $sql_registe = mysqli_query($conexionDB,"SELECT COUNT(*) AS total_registro FROM proveedores
                                                            WHERE (Nombre LIKE '%$busqueda%' OR
                                                                    Codigo_Postal LIKE '%$busqueda%' OR
                                                                    Email LIKE '%$busqueda%' 
                                                                    ) ");
